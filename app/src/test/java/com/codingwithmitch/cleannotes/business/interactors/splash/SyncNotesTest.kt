...
class SyncNotesTest {
    ...
    fun doSuccessiveUpdatesOccur() = runBlocking {
        ...
        val updatedNote = Note(
            ...
            createdAt = noteNetworkDataSource.getAllNotes()[0].createdAt,
            updatedAt = newDate
        )
...
//        println("BREAK")
    ...
    fun checkCacheUpdateLogicSync() = runBlocking {
        ...
        for (note in notesToUpdate) {
            ...
            assertEquals(note.updatedAt, networkNote?.updatedAt)
        }
    }
    ...
    fun checkNetworkUpdateLogicSync() = runBlocking {
        ...
        for(note in notesToUpdate){
            ...
            assertEquals(note.updatedAt, cacheNote?.updatedAt)
        }
    }
}